...
def compute_probabilities(
    ...
    for premises, hypotheses, _, relations in tqdm(dataloader, desc="Computing Probabilities:"):
        ...
        with torch.no_grad():
            ...
            batch_probs = F.softmax(outputs["logits"], dim=-1)[:, 0].cpu().tolist()  # Probability of entailment
        ...
        for i in range(batch_size):
            ...
            num_hypotheses = len(data_item.hypothesis_false) + 1  # Include the true hypothesis
...
if __name__ == "__main__":
    ...
    number_relation = 11
    mnli_data = compute_probabilities(mnli_data, tokenizer, model, number_relation, device, args.batch_size)
